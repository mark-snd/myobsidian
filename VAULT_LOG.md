...
## [2026-05-12] ingest | SND 법무 관련 노트 동기화 (deprecated vault → MainVault)
- 신규: 전환사채.md (CB 실행 2026-05 예정, 정관변경 2차 등기 필요)
- 신규: 회의/법무사 미팅 26-05.md (액션아이템 3개: 스톡옵션 명단 전송, 의사록→결의서, CB 계약서 검토)
- 업데이트: 정관 변경.md (구조화 + 2차 등기 예정 내용 추가)
- 업데이트: 주식매수선택권 계약.md (구조화 + 액션아이템 연결)
- 업데이트: MOC - SND.md (법무사 미팅 26-05, 전환사채 항목 추가)
